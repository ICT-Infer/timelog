...
patch -p2 -d serve/ < ${script_path}/../patch/serve/settings.py.patch
patch -p2 -d serve/ < ${script_path}/../patch/serve/urls.py.patch
...
python3 manage.py shell < timelog/scripts/setup/timelog_user_group.py
